...
class GiftCardsLogger {
     ...
     * @return void
     */
    public function log_activity( $action_type, $code, $amount = null, $user_id = null ) {
        if (!$this->enabled) {
            return;
        }
     ...
     * @return void
     */
    public function log_creation( $code, $balance, $user_id = null ) {
     ...
     * @return void
     */
    public function log_usage( $code, $amount_used, $user_id = null ) {
     ...
     * @return void
     */
    public function log_balance_adjustment( $code, $new_balance, $user_id ) {
     ...
     * @return void
     */
    public function log_expiration_update( $code, $expiration_date, $user_id ) {
     ...
     * @return void
     */
    public function log_deletion( $code, $user_id ) {
     ...
     * @return void
     */
    public function log_expiration_reminder_sent( $code, $user_id ) {
     ...
     * @return void
     */
    public function log_import_export( $action_type, $user_id, $count ) {
