...
class GiftCardEmail extends \WC_Email {
    ...
    /**
     * Sends an email with a PDF attachment generated from the gift card data.
     *
     * This function checks the required arguments, generates a PDF using the
     * GiftCardPDFGenerator class, saves it to the uploads directory, and sends
     * an email with the PDF as an attachment. If the PDF generation fails or
     * required arguments are missing, it attempts to send the email without
     * the PDF attachment.
     *
     * @param array $args {
     *     Array containing email details and gift card information.
     *
     *     @type string 'recipient' The email address of the recipient.
     *     @type string 'subject'   The subject of the email.
     *     @type string 'content'   The content/body of the email.
     *     @type string 'headers'   The headers for the email.
     *     @type object 'gift_card' The gift card data object.
     * }
     * 
     * @throws \Exception If required arguments are missing or PDF generation fails.
     * 
     * @return void
     */
